(() => {
  ...
  const ASSET = {
    ...
    copper_1: 'assets/sprites_gen/copper_1.png',
    copper_2: 'assets/sprites_gen/copper_2.png',
    copper_3: 'assets/sprites_gen/copper_3.png',
    copper_4: 'assets/sprites_gen/copper_4.png',
    copper_5: 'assets/sprites_gen/copper_5.png',
    iron_1: 'assets/sprites_gen/iron_1.png',
    iron_2: 'assets/sprites_gen/iron_2.png',
    iron_3: 'assets/sprites_gen/iron_3.png',
    iron_4: 'assets/sprites_gen/iron_4.png',
    iron_5: 'assets/sprites_gen/iron_5.png',
    fire_1: 'assets/sprites_gen/fire_1.png',
    fire_2: 'assets/sprites_gen/fire_2.png',
    fire_3: 'assets/sprites_gen/fire_3.png',
    fire_4: 'assets/sprites_gen/fire_4.png',
    fire_5: 'assets/sprites_gen/fire_5.png',
    wood_1: 'assets/sprites_gen/wood_1.png',
    wood_2: 'assets/sprites_gen/wood_2.png',
    wood_3: 'assets/sprites_gen/wood_3.png',
    wood_4: 'assets/sprites_gen/wood_4.png',
    wood_5: 'assets/sprites_gen/wood_5.png',
    ice_1: 'assets/sprites_gen/ice_1.png',
    ice_2: 'assets/sprites_gen/ice_2.png',
    ice_3: 'assets/sprites_gen/ice_3.png',
    ice_4: 'assets/sprites_gen/ice_4.png',
    ice_5: 'assets/sprites_gen/ice_5.png',
    enemy_shade: 'assets/sprites_gen/enemy_shade.png',
    enemy_runner: 'assets/sprites_gen/enemy_runner.png',
    enemy_brute: 'assets/sprites_gen/enemy_brute.png',
    enemy_boss: 'assets/sprites_gen/enemy_boss.png'
  };
  ...
  function showAnnouncement(title, subtitle='', kicker='FORGEFALL', duration=1450){
  ...
  async function openChest(index){
    ...
    showAnnouncement('Stai aprendo', 'Cassa del fabbro', 'CASSA SPECIALE', 900);
    ...
    showAnnouncement(`+${bonus} MOSSE`, 'La cassa del fabbro ti aiuta', 'RICOMPENSA', 1100);
    updateHUD();
  ...
  function spawnEnemy(forceBoss=false){
    ...
    const yaw = side > 0 ? 8 : -8;
    const e={id:wave.nextId++,type,lane,baseX,x:baseX,y:1.08,hp:stat.hp,maxHp:stat.hp,speed:stat.speed,damage:stat.damage,blocked:false,step:Math.random()*6.28,flip:side,yaw};
  ...
  function updateWave(dt){
    ...
    const rect=boardRect();wave.enemies.forEach(e=>{
      if(!e.el) return;
      const lean = (Math.sin(e.step*1.35) * (e.type==='runner' ? 4.2 : e.type==='brute' ? 3.6 : e.type==='boss' ? 2.8 : 3.2)) + (e.flip>0 ? 1.4 : -1.4);
